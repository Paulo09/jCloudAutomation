...
<style>
  ...
  //background: #fff;
   background:url(arduino.jpg) no-repeat center top fixed;
...
<img class="profile-img" src="arduino.jpg" alt="">
...
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Fazer login">
  ...
  <div class="bubble">
  Para sua proteção, mantenha esta opção selecionada apenas nos dispositivos que você utiliza regularmente.
...
<div class="one-google">
  ...
  <a  id="link-signup" href="https://accounts.google.com/SignUp?service=mail&amp;continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&amp;hl=pt-BR">
  Criar uma conta
  </a>
  </p>
<p class="tagline">
