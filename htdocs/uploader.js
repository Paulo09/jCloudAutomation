...
function onLoad()
{
	...
	if (connection) {
		frm.src = "http://www.arduinodev.com/start/uploader/info_" + lang + ".html";
	}
}
...
{
	document.getElementById("report").src = "http://www.arduinodev.com/start/uploader/report_" + lang + ".html?board=" + boardIndex + "&data=" + data;
