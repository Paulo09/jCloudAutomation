...
void setup()
{
  ...
  EthernetSupW5100.addButton(portaVentilador, "Abrir a Porta", "Fechar a Porta", FLIP_BUTTON);
  EthernetSupW5100.addButton(portaVentilador,"Porta Aberta","Porta Fechada",FLIP_BUTTON);
  EthernetSupW5100.addButton(portaFechadura, "Refre", "", SWITCH_BUTTON);
  EthernetSupW5100.addButton(portaFechadura, "Refresh", "", SWITCH_BUTTON);
  EthernetSupW5100.addButton(portaFechadura, "Refresh", "", SWITCH_BUTTON);
  EthernetSupW5100.addButton(portaFechadura, "Refresh", "", SWITCH_BUTTON);
}
...
void loop(){
  ...
  if(lastButton == portaLampada){digitalWrite(portaLampada,state);}
